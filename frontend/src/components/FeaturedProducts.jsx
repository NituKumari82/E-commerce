...
const FeaturedProducts = ({ featuredProducts }) => {
	...
	// FIX 1: Safety check to ensure featuredProducts is an array before checking .length
	const isStartDisabled = currentIndex === 0;
	const isEndDisabled = !Array.isArray(featuredProducts) || currentIndex >= featuredProducts.length - itemsPerPage;

	// FIX 2: Early return if data isn't ready or is the wrong type
			...
			<div className='container mx-auto px-4'>
				...
				<div className='relative'>
					<div className='overflow-hidden'>
						...
						>
							{/* FIX 3: Double-check array type before mapping */}
